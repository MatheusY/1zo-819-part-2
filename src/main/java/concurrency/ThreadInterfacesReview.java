...
public class ThreadInterfacesReview {
	public static void main(String[] args) {
		...
		Runnable r1 = () -> {
			throw new RuntimeException("Runnable chokes in service.execute()");
		};
...
//		};
		...
		// throws unchecked exception
		Runnable r2 = () -> {
			throw new RuntimeException("Runnable chokes in service.submit()");
		};
		...
		// throws unchecked exception
		Callable<Void> c = () -> {
			throw new RuntimeException("Callable chokes in service.submit()");
		};
