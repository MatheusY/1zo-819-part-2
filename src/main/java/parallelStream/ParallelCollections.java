...
class Person {
	...
	private static String[] names = { "Anne", "Bob", "Carol", "David", "Evan", "Fred", "George", "Harold", "Ida",
			"Jack", "Kevin" };
...
public class ParallelCollections {
	public static void main(String[] args) {
		...
		System.out.println("Characteristics of Collectors.toMap() are " + c1.characteristics());

		// Create a Collector using Collectors.toConcurrentMap
		Collector c2 = Collectors.toConcurrentMap(String::length, s -> s);
		System.out.println("Characteristics of Collectors." + "toConcurrentMap() are " + c2.characteristics());

		// Create a Collector using Collectors.groupingBy
		Collector c3 = Collectors.groupingBy(Person::getAge);
		System.out.println("Characteristics of Collectors." + "groupingBy(Person::getAge) are " + c3.characteristics());
		...
		System.out.println("Characteristics of Collectors." + "groupingByConcurrent() are " + c4.characteristics());
