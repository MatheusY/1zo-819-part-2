...
public class ParallelStreamTests {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tests; i++) {
            ...
            Optional<Integer> findAnyParallel = randomIntegerList
                    .parallelStream()
                    .findAny();

            parallelAnys[i] = (Integer) findAnyParallel.get();

            Optional<Integer> findAnySerial = randomIntegerList
                    .stream()
                    .findAny();
            ...
            Optional<Integer> findFirstParallel = randomIntegerList
                    .parallelStream()
                    .findFirst();

            parallelFirsts[i] = (Integer) findFirstParallel.get();

            Optional<Integer> findFirstSerial = randomIntegerList
                    .stream()
                    .findFirst();
