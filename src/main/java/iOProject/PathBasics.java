...
public class PathBasics {
    ...
    public static void pathCreations() {
        ...
        Path cdir = Paths.get("/home/matheus/Dev/Projects/1zo-819-part-2",
                "target/classes");
        System.out.println(cdir.toAbsolutePath());

        // Using Path.of to get a path using Strings
        Path cdir2 = Path.of("target", "classes", "iOProject");
        ...
        Path filePath1 = Paths.get(URI.create(
                "file:///home/matheus/1zo-819-part-2/characterData.txtcharacterData.txt"));
        ...
        Path filePath2 = FileSystems.getDefault().getPath("/home/matheus",
                new String[]{
                        "1zo-819-part-2",
                        "characterData.txt"});
